...
/**
 * MaintainPostalAddressServiceHandlerImpl
 * 
 * @author Nicolas Moser, PRODYNA AG
 */
public class MaintainPostalAddressServiceHandlerImpl extends MaintainPostalAddressServiceHandler {

    private static final long serialVersionUID = 1L;

    @Override
    protected PostalAddressMsg maintainPostalAddress(PostalAddressMsg msg) throws MaintainException {
