...
/**
 * SearchPostalAddressServiceHandlerImpl
 * 
 * @author Dominic Trumpfheller, PRODYNA AG
 */
public class SearchPostalAddressServiceHandlerImpl extends SearchPostalAddressServiceHandler {

    private static final long serialVersionUID = 1L;

    @Override
    protected PostalAddressListMsg searchPostalAddress(PostalAddressSearchRq msg) throws SearchException {

        StringBuilder queryString = new StringBuilder();
        queryString.append("select a from PostalAddress a");

        List<PostalAddress> resultList;
        try {
        ...
        response.getPostalAddressList().addAll(resultList);
        return response;
    }
