...
/**
 * ProducePhoneAddressServiceHandlerImpl
 * 
 * @author Nicolas Moser, PRODYNA AG
 */
public class ProducePhoneAddressServiceHandlerImpl extends ProducePhoneAddressServiceHandler {

    private static final long serialVersionUID = 1L;

    @Override
    protected PhoneAddressListMsg producePhoneAddress(PhoneAddressProduceRq msg) throws ProduceException {

        PhoneAddressListMsg response = new PhoneAddressListMsg();

        for (int i = 0; i < msg.getAmount().getValue(); i++) {
            PhoneAddress address = new PhoneAddress();
            ...
            response.getPhoneAddressList().add(address);
        }
